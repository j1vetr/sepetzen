...
export const TURKEY_CITIES: Record<string, string[]> = {
  ...
  "Ankara": ["Altındağ","Ayaş","Balâ","Beypazarı","Çamlıdere","Çankaya","Çubuk","Elmadağ","Etimesgut","Evren","Gölbaşı","Güdül","Haymana","Kahramankazan","Kalecik","Keçiören","Kızılcahamam","Mamak","Nallıhan","Polatlı","Pursaklar","Sincan","Şereflikoçhisar","Yenimahalle"],
  "Antalya": ["Aksu","Akseki","Alanya","Demre","Döşemealtı","Elmalı","Finike","Gazipaşa","Gündoğmuş","İbradı","Kaş","Kemer","Kepez","Konyaaltı","Korkuteli","Kumluca","Manavgat","Muratpaşa","Serik"],
  ...
  "Bingöl": ["Adaklı","Bingöl Merkez","Genç","Karlıova","Kiğı","Merkez","Solhan","Yayladere","Yedisu"],
  ...
  "Çankırı": ["Atkaracalar","Bayramören","Çankırı Merkez","Eldivan","Ilgaz","Khaniye","Korgun","Kurşunlu","Orta","Şabanözü","Yapraklı"],
  ...
  "Eskişehir": ["Alpu","Beylikova","Çifteler","Eskişehir Merkez","Günyüzü","Han","İnönü","Mahmudiye","Mihalgazi","Mihalıçcık","Odunpazarı","Sarıcakaya","Seyitgazi","Sivrihisar","Tepebaşı"],
  ...
  "Kırıkkale": ["Bahşili","Balışeyh","Çelebi","Delice","Karakılıç","Kırıkkale Merkez","Keskin","Sulakyurt","Yahşihan"],
  ...
  "Samsun": ["Alaçam","Asarcık","Atakum","Ayvacık","Bafra","Canik","Çarşamba","İlkadım","Kavak","Ladik","Salıpazarı","Tekkeköy","Terme","Vezirköprü","Yakakent"],
  ...
  "Sivas": ["Akıncılar","Altınyayla","Divriği","Doğanşar","Gemerek","Gölova","Hafik","İmranlı","Kangal","Koyulhisar","Sivas Merkez","Şarkışla","Ulaş","Yıldızeli","Zara"],
  ...
  "Trabzon": ["Akçaabat","Araklı","Arsin","Beşikdüzü","Çarşıbaşı","Çaykara","Dernekpazarı","Düzköy","Hayrat","Köprübaşı","Maçka","Of","Ortahisar","Şalpazarı","Tonya","Vakfıkebir","Yomra"],
  ...
  "Yalova": ["Altınova","Armutlu","Çiftlikköy","Çınarcık","Termal","Yalova Merkez"],
