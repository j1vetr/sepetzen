...
export default function Register() {
  ...
  return (
    <AuthLayout
      ...
      seoUrl="/kayit"
      title="HESAP OLUŞTUR"
      subtitle="Birkaç saniyede üye olun, adres bilgilerinizi sipariş sırasında ekleyin."
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={handleChange} placeholder="Adınız"
              autoComplete="given-name" data-testid="input-firstName"
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              autoComplete="family-name" data-testid="input-lastName"
              className={authInputCls}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              required autoComplete="email" data-testid="input-email"
              className={authInputCls}
            />
          </div>
          <div className="space-y-1.5">
