...
const statusConfig: Record<string, { label: string; color: string; icon: React.ElementType; bg: string }> = {
  pending: { label: 'Beklemede', color: 'text-white/55', icon: Clock, bg: 'bg-white/5 border border-white/8' },
  processing: { label: 'İşleniyor', color: 'text-white/80', icon: Package, bg: 'bg-white/10 border border-white/25' },
  shipped: { label: 'Kargoda', color: 'text-white/80', icon: Truck, bg: 'bg-white/12 border border-white/30' },
  delivered: { label: 'Teslim Edildi', color: 'text-white', icon: CheckCircle2, bg: 'bg-white text-black border border-white/12' },
  completed: { label: 'Tamamlandı', color: 'text-white', icon: CheckCircle2, bg: 'bg-white text-black border border-white/12' },
      ...
      <main className="pt-8 pb-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-baseline gap-4 mb-3">
                  <span className="text-[11px] font-mono tracking-[0.32em] uppercase text-white tabular-nums">01 / Üye Paneli</span>
                  <span className="h-px w-10 bg-white/30" />
                </div>
                <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl tracking-[0.005em] text-white leading-[0.98]" data-testid="text-page-title">
                  HESABIM
                </h1>
                <p className="text-white/55 mt-3 text-sm">
                  Hoş geldin, <span className="text-white font-medium">{user.firstName || user.email.split('@')[0]}</span>
                </p>
              </div>
              <button
                onClick={handleLogout}
                className="flex items-center gap-2 px-4 py-2 text-sm text-white/55 hover:text-white transition-colors"
          ...
          <div className="grid lg:grid-cols-4 gap-6">
            ...
            >
              <div className="bg-[#141414] border border-white/8 rounded-md p-6 sticky top-28">
                <div className="flex flex-col items-center mb-7 pb-7 border-b border-white/8">
                    ...
                    <button
                      ...
                      className={`group w-full flex items-center justify-between gap-3 px-6 py-4 border-l-2 transition-all ${
                        activeTab === tab.id
                          ...
                          : 'border-transparent text-white/55 hover:text-white hover:border-white/20 hover:bg-white/[0.02]'
                      }`}
                    ...
                    >
                      ...
                      {tab.count !== undefined && (
                        <span className={`text-[10px] font-mono tabular-nums tracking-wider px-2 py-0.5 ${
                          activeTab === tab.id ? 'bg-white text-black' : 'bg-white/8 text-white/55'
                        }`}>
                ...
                {activeTab === 'orders' && (
                  ...
                  >
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <p className="text-sm text-white/45">{orders.length} sipariş</p>
                    </div>
                    ...
                    {ordersLoading ? (
                      ...
                      <div className="bg-[#141414] border border-white/8 rounded-2xl p-12 text-center">
                        ...
                        <p className="text-white/45 mb-6">Alışverişe başlayarak ilk siparişinizi oluşturun.</p>
                        <button
                          onClick={() => navigate('/')}
                          className="px-6 py-3 bg-white text-black rounded-md font-medium hover:bg-white/85 transition-colors"
                        ...
                        {orders.map((order) => {
                          ...
                          return (
                            <motion.div
                              ...
                              initial={{ opacity: 0, y: 10 }}
                              animate={{ opacity: 1, y: 0 }}
                              className="bg-[#141414] border border-white/8 rounded-2xl p-5 hover:border-white/12 transition-colors"
                            ...
                            >
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                ...
                                <button
                                  ...
                                  className="flex items-center gap-2 px-4 py-2 bg-[#151515] hover:bg-white/8 rounded-xl text-sm font-medium text-white transition-colors"
                ...
                {activeTab === 'favorites' && (
                  ...
                  >
                    ...
                    {favoritesLoading ? (
                      ...
                      <div className="bg-[#141414] border border-white/8 rounded-2xl p-8 text-center">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#151515] flex items-center justify-center">
                          <Heart className="w-8 h-8 text-white/25" />
                        </div>
                        <h3 className="text-lg font-semibold text-white mb-2">Henüz favori ürününüz yok</h3>
                        <p className="text-white/45 mb-6">Beğendiğiniz ürünleri favorilere ekleyin, daha sonra kolayca bulun.</p>
                        <Link href="/">
                          <button className="px-6 py-3 bg-white text-black rounded-md font-medium hover:bg-white/85 transition-colors">
                            Alışverişe Başla
                          </button>
                        </Link>
                      </div>
                      ...
                      {isEditing ? (
                        <div className="space-y-4">
                          <div className="grid sm:grid-cols-2 gap-4">
                            <div>
                              <label className="block text-sm font-medium text-white/55 mb-2">Ad</label>
                              <input
                                type="text"
                            ...
                            <div>
                              <label className="block text-sm font-medium text-white/55 mb-2">Soyad</label>
                              <input
                                type="text"
                          ...
                          <div>
                            <label className="block text-sm font-medium text-white/55 mb-2">Telefon</label>
                            <input
                              type="tel"
                          ...
                          <div className="flex gap-3 pt-4">
                            <button
                              ...
                              className="flex-1 px-4 py-3 border border-white/12 rounded-md text-white hover:bg-white/5 transition-colors"
                            ...
                            <button
                              ...
                              className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-white text-black rounded-md font-medium hover:bg-white/85 transition-colors disabled:opacity-50"
                        ...
                        <div className="space-y-6">
                          <div className="grid sm:grid-cols-2 gap-6">
                            <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                              <div className="w-12 h-12 rounded-full bg-white/8 flex items-center justify-center">
                                <User className="w-6 h-6 text-white/55" />
                              </div>
                              <div>
                                <p className="text-xs text-white/45 uppercase tracking-wider">Ad Soyad</p>
                            ...
                            <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                              <div className="w-12 h-12 rounded-full bg-white/8 flex items-center justify-center">
                                <Mail className="w-6 h-6 text-white/55" />
                              </div>
                              <div>
                                <p className="text-xs text-white/45 uppercase tracking-wider">E-posta</p>
                                <p className="text-white font-medium">{user.email}</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                              <div className="w-12 h-12 rounded-full bg-white/8 flex items-center justify-center">
                                <Phone className="w-6 h-6 text-white/55" />
                              </div>
                              <div>
                                <p className="text-xs text-white/45 uppercase tracking-wider">Telefon</p>
                                <p className="text-white font-medium">{(user as any)?.phone || '-'}</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                              <div className="w-12 h-12 rounded-full bg-white/8 flex items-center justify-center">
                                <Calendar className="w-6 h-6 text-white/55" />
                              </div>
                              <div>
                                <p className="text-xs text-white/45 uppercase tracking-wider">Üyelik Tarihi</p>
                                <p className="text-white font-medium">
                          ...
                          <div className="pt-6 mt-2 border-t border-white/8">
                            <h3 className="text-sm font-semibold text-white mb-3 tracking-[0.04em] uppercase">
                              İletişim Tercihleri
                            </h3>
                            <div className="flex items-start justify-between gap-4 p-4 bg-white/5 rounded-xl">
                              <div className="flex items-start gap-3 min-w-0">
                                <div className="w-10 h-10 rounded-full bg-white/8 flex items-center justify-center shrink-0">
                                  <Phone className="w-5 h-5 text-white/55" />
                                </div>
                                <div className="min-w-0">
                                  <p className="text-white font-medium" data-testid="text-whatsapp-pref-title">WhatsApp bildirimleri</p>
                              ...
                              <button
                                ...
                                className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors disabled:opacity-50 ${
                                  user?.whatsappOptIn !== false ? 'bg-white' : 'bg-white/15'
                                }`}
                                data-testid="toggle-whatsapp-opt-in"
                              >
                                <span
                                  className={`inline-block h-4 w-4 transform rounded-full bg-[#141414] shadow transition-transform ${
                  ...
                  >
                    <div className="flex items-center justify-between mb-6">
                      ...
                      {!showAddressForm && (
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 bg-white text-black rounded-md text-sm font-medium hover:bg-white/85 transition-colors"
                    ...
                    {showAddressForm ? (
                      <div className="bg-[#141414] border border-white/8 rounded-2xl p-6">
                        ...
                        <div className="space-y-4">
                          <div>
                            <label className="block text-sm font-medium text-white/55 mb-2">Adres Başlığı *</label>
                            <input
                              type="text"
                          ...
                          <div>
                            <label className="block text-sm font-medium text-white/55 mb-2">Adres *</label>
                            <input
                              type="text"
                          ...
                          <div className="grid sm:grid-cols-2 gap-4">
                            <div>
                              <label className="block text-sm font-medium text-white/55 mb-2">Posta Kodu</label>
                              <input
                                type="text"
                            ...
                            <div>
                              <label className="block text-sm font-medium text-white/55 mb-2">Ülke *</label>
                              <select
                          ...
                          <div className="flex items-center gap-3">
                            <input
                              ...
                              className="w-5 h-5 rounded border border-white/30 accent-white"
                              data-testid="checkbox-address-default"
                            />
                            <label htmlFor="isDefault" className="text-sm text-white/55">
                            ...
                            <div className="flex items-start justify-between gap-4">
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-2">
                                  <Home className="w-4 h-4 text-white/45" />
                                  <span className="font-semibold text-white">{addr.title}</span>
                                  {addr.isDefault && (
                                    <span className="text-[10px] bg-white/12 text-white/80 font-semibold uppercase tracking-wider px-2 py-0.5 rounded-md">
                                      Varsayılan
                                    </span>
                                  )}
                                </div>
                                <p className="text-white/70">{addr.firstName} {addr.lastName}</p>
                              ...
                              <div className="flex gap-2">
                                <button
                                  ...
                                  className="p-2 hover:bg-[#151515] rounded-lg transition-colors text-white/55 hover:text-white"
                                ...
                                <button
                                  ...
                                  className="p-2 hover:bg-destructive/10 rounded-lg transition-colors text-white/55 hover:text-destructive"
        ...
        {selectedOrder && (
          ...
          >
            <motion.div
              ...
              className="bg-[#141414] border border-white/8 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-auto"
              ...
              <div className="p-6 space-y-6">
                ...
                {selectedOrder.status === 'shipped' && (
                  <div className="bg-white/5 border border-white/10 rounded-md p-5">
                    <div className="flex items-center justify-center gap-2 mb-3">
                      <Truck className="w-5 h-5 text-white/70" strokeWidth={2} />
                      <span className="text-white font-bold text-sm tracking-[0.2em] uppercase">Aras Kargo</span>
                    </div>
                    
                    <div className="text-center mb-3">
                      <p className="text-xs text-white/55 uppercase tracking-wider mb-1">Kargo Takip Numarası</p>
                    ...
                    {selectedOrder.trackingNumber && (
                      <a
                        ...
                        className="flex items-center justify-center gap-2 w-full py-2.5 bg-white text-black hover:bg-white/85 rounded-md font-bold text-[11px] tracking-[0.18em] uppercase transition-colors"
                      >
                ...
                {selectedOrder.trackingNumber && selectedOrder.status !== 'shipped' && (
                  <div className="p-4 bg-white/5 rounded-xl">
                    ...
                    {selectedOrder.shippingCarrier && (
                      <p className="text-sm text-white/45 mt-1">{selectedOrder.shippingCarrier}</p>
                    )}
                  </div>
                )}

                <div>
                  <h4 className="text-sm font-medium text-white/55 mb-3 uppercase tracking-wider">Ürünler</h4>
                  {orderDetailLoading ? (
                ...
                <div>
                  ...
                  <div className="p-4 bg-white/5 rounded-xl">
                    ...
                    <p className="text-white/55">{selectedOrder.shippingAddress.address}</p>
                    <p className="text-white/55">
                      {selectedOrder.shippingAddress.district}, {selectedOrder.shippingAddress.city} {selectedOrder.shippingAddress.postalCode}
                    </p>
                    <p className="text-white/55 mt-2">{selectedOrder.customerPhone}</p>
                  </div>
                </div>

                <div>
                  <h4 className="text-sm font-medium text-white/55 mb-3 uppercase tracking-wider">Özet</h4>
                  <div className="p-4 bg-white/5 rounded-xl space-y-2">
                    ...
                    <div className="flex justify-between text-white font-bold text-lg pt-2 border-t border-white/12">
                      <span>Toplam</span>
