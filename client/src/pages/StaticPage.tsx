      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 lg:px-8 py-12 lg:py-20">
        ...
        {isError && (
          <div className="flex flex-col items-center justify-center py-24 gap-4 text-center">
            ...
            <h1 className="text-2xl font-display text-white">Sayfa Bulunamadı</h1>
            <p className="text-white/55">Aradığınız sayfa mevcut değil.</p>
            <Link href="/" className="mt-4 inline-flex items-center gap-2 text-white hover:underline font-medium">
              ← Ana sayfaya dön
            </Link>
          </div>
        )}
        ...
        {page && (
          <>
            <div className="mb-8 pb-6 border-b border-border">
              ...
              <h1 className="text-3xl lg:text-4xl font-display text-white">
                {page.title}
              </h1>
            </div>
